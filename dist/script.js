...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(officer, counter, items, plusSelector) {
      officer.querySelector(plusSelector).addEventListener('click', function () {
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "checkTextInputs",
    value: function checkTextInputs(selector) {
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElement = this.activeBtn.closest('.module__video-item').nextElementSibling;
        ...
        if (state.data === 0) {
          if (blockedElement.querySelector('.play__circle').classList.contains('closed')) {
            ...
            blockedElement.querySelector('.play__circle').appendChild(playBtn);
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            var activeSlide = _this2.slides[i];

            _this2.container.insertBefore(activeSlide, _this2.slides[0]);
